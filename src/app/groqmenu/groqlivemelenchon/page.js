      ...
      try {
        ...
        if(lo==0){
          ...
          newMessage = { role: 'user', 
           content:`adopte le role de jean luc melechon ,homme politique francais .
           adopte un ton direct , franc , assez dur mais juste dans tes phrases .`
}
        } else {
    ...
    for (let sentence of sentences) {
      ...
      try {
        const response = await axios.post('http://127.0.0.1:8010/synthesize', {
          ...
          ref_speaker_wav: "speakers/melenchon.wav",
          // ref_speaker_wav: "speakers/zemmour.wav",
        //   ref_speaker_wav: "speakers/remi2.wav",
          options: {
            temperature: 0.75,
            length_penalty: 1,
